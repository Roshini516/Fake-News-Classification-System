...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><span class="style5">A Taxonomy of Fake News Classification Techniques Survey and Implementation Aspects</span><br />
        </h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
	   ...
	   <h2 class="style10">Upload Datasets !!! </h2>
          ...
          <p>&nbsp;</p>
          <p> 
		  <form name="vinform" action="user_upload_Datasets1.jsp" method="post" id ="firstForm"> 
            <table width="424">
              <tr>
