      ...
      <div class="entry">
        <div id="templatemo_right_section">
          ...
          <%
				...
				%>
          <p align="left"><a href="register_user.jsp" class="style5 style14">Back</a></p>
          <%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,pincode,status,image,count) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						{
						%>
          <p class="style6">Registered Successfully <a href="user.jsp" class="style16">Log In Now</a></p>
          <%
